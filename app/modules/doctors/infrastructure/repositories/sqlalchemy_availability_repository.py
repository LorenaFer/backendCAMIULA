...
class SQLAlchemyAvailabilityRepository(AvailabilityRepository):
    ...
    def _to_entity(model: DoctorAvailabilityModel) -> DoctorAvailability:
        return DoctorAvailability(
            ...
            start_time=model.start_time.strftime("%H:%M") if hasattr(model.start_time, 'strftime') else model.start_time,
            end_time=model.end_time.strftime("%H:%M") if hasattr(model.end_time, 'strftime') else model.end_time,
